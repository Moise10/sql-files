...
Create SQL statement to print all records from Bookings table for the following bookings
 dates using the BETWEEN operator: 2021-11-11, 2021-11-12 and 2021-11-13. */
...
The statement must print the customers full names and related bookings 
IDs from the date 2021-11-11.*/
...
Create a SQL REPLACE statement that updates 
the cost of the Kabsa course from $17.00 to $20.00. */

REPLACE INTO Courses(CourseName, Cost) VALUES( 'Kabasa', 20);


/*Task 5: Create constraints
Create a new table called "DeliveryAddress" 
in the Little Lemon database with the following columns and constraints:
ID: INT PRIMARY KEY
...
Create a SQL statement with a subquery that prints the full names of all
customers who made bookings in the restaurant on the following date: 2021-11-11.*/
...
/*Create a SQL SELECT query using the appropriate MySQL string function 
